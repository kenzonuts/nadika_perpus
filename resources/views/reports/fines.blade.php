...
@section('content')
    <div class="max-w-[1600px] mx-auto space-y-6" x-data="{ searchQuery: '', status: 'all' }">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <x-dashboard.stat-card title="Total Collected" value="Rp 18.5M" icon="banknotes" trend="22.1%" :trend-up="true" color="success" />
            <x-dashboard.stat-card title="Outstanding" value="Rp 2.4M" icon="exclamation-triangle" color="danger" />
            <x-dashboard.stat-card title="Avg. Fine Amount" value="Rp 32,500" icon="calculator" color="warning" />
            <x-dashboard.stat-card title="Waived This Month" value="Rp 450K" icon="hand-raised" color="neutral" />
        </div>
