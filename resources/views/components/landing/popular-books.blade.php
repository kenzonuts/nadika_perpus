...
>
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center justify-between mt-3">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <span class="text-sm font-medium text-secondary">{{ $book['borrows'] }} borrows</span>
                            </div>
                        </div>
                        ...
                        <x-ui.button
                            ...
                            :href="route('login')"
                        >
                            {{ $book['available'] ? 'Borrow Now' : 'Sign in to borrow' }}
                        </x-ui.button>
                    </div>
                </article>
            @endforeach
    ...
    @else
        <div class="text-center py-12 text-secondary/50">
